server '104.131.175.145', port: 22, roles: [:web, :app, :db], primary: true
...
set :nginx_access_log, "#{release_path}/log/nginx.access.log"
set :nginx_error_log, "#{release_path}/log/nginx.error.log"
